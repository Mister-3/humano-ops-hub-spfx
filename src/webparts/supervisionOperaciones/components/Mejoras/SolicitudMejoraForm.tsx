...
export const SolicitudMejoraForm: React.FC<ISolicitudMejoraFormProps> = ({
  ...
  return (
    <form className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 shadow-xl backdrop-blur-md flex flex-col gap-6" onSubmit={(e) => void handleSubmit(e)}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="w-full bg-slate-900/80 border border-slate-800 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all"
        ...
        <div className="flex flex-col gap-2">
          ...
          <select
            disabled={isSubmitting}
            className="w-full bg-slate-900/80 border border-slate-800 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all cursor-pointer"
            value={moduloAfectado}
            onChange={(e) => setModuloAfectado(e.target.value)}
            required
          >
            <option value="" disabled className="bg-slate-900 text-slate-400">Seleccione el módulo objetivo...</option>
        ...
        <div className="md:col-span-2 bg-slate-900/40 border border-slate-800/80 rounded-xl p-4 space-y-4">
      ...
      <div className="flex items-center gap-3 pt-2">
        <button
          type="submit"
          disabled={isSubmitting}
          className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium px-5 py-2.5 shadow-sm transition-all inline-flex items-center gap-2 text-sm disabled:opacity-50 cursor-pointer"
        >
          <Icon iconName="Send" />
