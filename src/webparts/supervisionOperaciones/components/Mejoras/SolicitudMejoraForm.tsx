...
export const SolicitudMejoraForm: React.FC<ISolicitudMejoraFormProps> = ({
  ...
  return (
    <form className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm flex flex-col gap-6" onSubmit={(e) => void handleSubmit(e)}>
      <div className="flex flex-col gap-1">
        <h3 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
          <span>💡</span> Proponer Nueva Historia de Usuario
        </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2.5 text-slate-900 dark:text-slate-100 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all font-medium text-sm outline-none"
        ...
        <div className="flex flex-col gap-2">
          ...
          <select
            disabled={isSubmitting}
            className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2.5 text-slate-900 dark:text-slate-100 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all font-medium text-sm outline-none cursor-pointer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                type="text"
                disabled={isSubmitting}
                className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2.5 text-slate-900 dark:text-slate-100 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all text-sm outline-none"
        ...
        <div className="md:col-span-2 flex flex-col gap-2">
          ...
          <textarea
            disabled={isSubmitting}
            rows={3}
            className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2.5 text-slate-900 dark:text-slate-100 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all font-medium text-sm outline-none resize-none"
      ...
      <div className="flex items-center gap-3 pt-2">
        <button
          type="submit"
          disabled={isSubmitting}
          className="bg-blue-600 text-white hover:bg-blue-700 rounded-xl font-medium px-5 py-2.5 shadow-sm transition-all inline-flex items-center gap-2 text-sm disabled:opacity-50 cursor-pointer"
        >
          <Icon iconName="Send" />
