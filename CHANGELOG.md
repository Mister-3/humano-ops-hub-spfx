...
- **Protocolo de Desarrollo Híbrido (Codex & Antigravity)**: Definición formal de responsabilidades, convención de ramas (`feature/codex/*`, `feature/antigravity/*`, `docs/antigravity/*`), formato de commits firmados y protocolo de protección de base de datos en `AGENTS.md`.
